 ...
 * @author Guerrero
 */
public class RegistrarConJInternalFrame extends javax.swing.JInternalFrame {

    /**
     * Creates new form RegistrarConJInternalFrame
     */
    public RegistrarConJInternalFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Nombre del Consultorio:");

        btnRegistrar.setBackground(new java.awt.Color(153, 153, 153));
        btnRegistrar.setFont(new java.awt.Font("Arial Narrow", 0, 12)); // NOI18N
        ...
        btnNuevo.setFont(new java.awt.Font("Arial Narrow", 0, 12)); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
         Controlador.ControlConRegistrar registra=new Controlador.ControlConRegistrar(this);
         registra.RegistrarConsultorio();
